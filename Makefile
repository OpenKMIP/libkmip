...
demo_get: demo_get.o memset.o
	$(CC) $(LDFLAGS) -L/usr/local/lib -o demo_get demo_get.o memset.o $(LDLIBS) -lssl -lcrypto
demo_create: demo_create.o memset.o
	$(CC) $(LDFLAGS) -L/usr/local/lib -o demo_create demo_create.o memset.o $(LDLIBS) -lssl -lcrypto
demo_destroy: demo_destroy.o memset.o
	$(CC) $(LDFLAGS) -L/usr/local/lib -o demo_destroy demo_destroy.o memset.o $(LDLIBS) -lssl -lcrypto
